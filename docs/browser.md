...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/gamecreditscore-lib.min.js"></script>
...
<body>
  ...
  <script type="text/javascript">
    var bitcore = require('gamecreditscore-lib');
...
```sh
browserify --require ./index.js:gamecreditscore-lib | uglifyjs > gamecreditscore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external gamecreditscore-lib | uglifyjs > bitcore-mnemonic.min.js
```
